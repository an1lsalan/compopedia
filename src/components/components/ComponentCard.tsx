            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden transition-shadow hover:shadow-lg">
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-gray-500">{formatDate(component.createdAt)}</span>
                    </div>
                    <h3 className="text-lg font-semibold mb-2">{component.title}</h3>
                    <p className="text-gray-600 text-sm line-clamp-2">{truncateText(component.description, 120)}</p>
